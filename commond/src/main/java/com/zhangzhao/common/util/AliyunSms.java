...
public class AliyunSms {
     ...
     * @return
     */
    public static StatusVoidVo verificationCode(String phone, String code, SMSCode smsCode) {
        ...
        try {
//            SMSCode smsCode = (SMSCode)session.getAttribute("smsCode:"+phone);//session判断
...
//        try {
//            sendSmsResponse = AliyunSms.sendSms(phone,name,code);
